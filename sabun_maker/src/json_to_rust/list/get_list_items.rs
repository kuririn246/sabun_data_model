...
pub fn get_list_items(array : &[JVal], auto_id : bool,  span : &Span, names : &Names) -> Result<Vec<RustObject>>{
...
///need_idは、initial_jsonでAutoIDでない場合は必要になるが、変化後のデータをjson化した場合は、AutoIDであってもIDが既に割り振られているので、いらない。
