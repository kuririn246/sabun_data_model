...
//         b.iter(|| lookup_str_vec(&names, &map))
//     }
//
//     #[bench]
...
//         b.iter(|| lookup_hash_map(&names, &map))
//     }
//
//     #[bench]
...
//         b.iter(|| lookup_hash_map_with_box(&names, &map))
//     }
//
//     #[bench]
...
//         b.iter(|| lookup_index_map(&names, &map))
//     }
//
//     #[bench]
...
//         b.iter(|| lookup_linked_hash_map(&names, &map))
//     }
//
//
