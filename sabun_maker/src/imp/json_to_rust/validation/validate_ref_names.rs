...
pub fn validate_ref_names(list_name : &str, list_items : &[RustObject], list_def_ref : &IndexMap<String, (Qv<String>, ValueType)>, root_renamed : &BTreeMap<String, String>) -> Result<()>{
