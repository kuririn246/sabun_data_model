...
use crate::structs::rust_list::{ConstList, ListItem, ConstData};
...
impl TmpList{
    pub fn new(span : Span) -> TmpList{
        TmpList{ vec : vec![], old : None, default : None, compatible : None, span }
    }
    ...
    pub fn to_const_data(self) -> ConstData{
        ...
        Ok(ConstData{ default : self.default.unwrap(), old, list : to_list_items(self.vec) })
    }
}
