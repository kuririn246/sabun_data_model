...
impl MemberDesc{
    pub(crate) fn new(name : String, value_type : ValueType, member_type : RustMemberType, is_old : bool) -> MemberDesc{
...
pub fn get_list_def_desc(def : &ListDefObj) -> MemberDescs{
    ...
    for (k,val) in def.default(){
        ...
        let (mt, vt) = match val{
            ...
            ListDefValue::InnerDataDef(_) => (RustMemberType::InnerData, ValueType::Normal),
            ListDefValue::InnerListDef(_) => (RustMemberType::InnerList, ValueType::Normal),
